...
namespace InvoiceApp.Functions
{
    public class PdfGenerator
    {
            ...
            [HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestData req)
        {
            ...
            string htmlReceiverInfo = $@"<tr class='information'><td colspan='5'>
                                        <table>
                                        <tr>
                                        <td>OptiCorp<br />Laberget 28<br />4020, Stavanger</td>
                                        <td class='right-align'>Invoice ID: {invoice.Id}<br />Sent: {invoice.SentDate}<br />To: {invoice.Receiver}</td>
                                        </tr>
                                        </table>
                                        </tr>";
